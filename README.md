...
ITile[T]: The atomic unit of processing in RDPro, containing a multidimensional array of pixels of type T and spatial metadata.

RasterMetadata: Stores the global extent, SRID (CRS), and resolution (width/height).
